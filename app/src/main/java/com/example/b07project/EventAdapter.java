...
public class EventAdapter extends ArrayAdapter<EventItem> {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.event_spinner_row, parent, false);
        }

        TextView eventName = convertView.findViewById(R.id.eventNameRow);
